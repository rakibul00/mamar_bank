...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user, amount, "Withdrawal Message", "transaction/withdrawal_email.html")
        return super().form_valid(form)
...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user, amount, "Loan Request Message", "transaction/loan_email.html")
        return super().form_valid(form)
